...
DATOS = {
    "Pequeña (1-10)": [
        {"id": "1", "titulo": "Asignación de persona que diseña el SG-SST", "subs": ["Acta de designación", "Hoja de vida", "Licencia SST", "Curso 50h"], "f": "Garantiza competencia técnica.", "p": "Semestral"},
